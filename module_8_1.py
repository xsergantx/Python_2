...
def add_everything_up(a, b):
    try:
        ...
        if isinstance(a, (int, float)) and isinstance(b, (int, float)):# целые числа и с плав. точкой
            return a + b

        elif isinstance(a, str) and isinstance(b, str):# строки
            return a + b
